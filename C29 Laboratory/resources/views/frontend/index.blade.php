                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="200">
                        <div class="service-box blue">
                            ...
                            <h3>SWAB</h3>
                            <p>Pengambilan sample dari hidung dan analisis hasil tes covid-19.</p>
                            <a href="{{ route('login') }}" class="read-more"><span>Login</span> <i
                    ...
                    <div class="col-lg-6 col-md-6 aos-init aos-animate" data-aos="fade-up" data-aos-delay="300">
                        <div class="service-box orange">
                            <i class="ri-discuss-line icon"></i>
                            <h3>Consultation</h3>
                            <p>konsultasi mengenai apapun seputar kesehatan.</p>
                            <a href="{{ route('login') }}" class="read-more"><span>Login</span> <i
                                    class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                            ...
                            @foreach ($faqs as $faq)
                                <div class="accordion-item">
                                    ...
                                    @foreach ($faq->child as $val)
                                        <div id="faq-content-{{ $val->parent_id }}" class="accordion-collapse collapse"
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    @foreach ($artikels as $artikel)
                        <div class="col-lg-4">
                            <div class="post-box">
                                <div class="post-img"><img src="{{ url('storage/' . $artikel->image . '') }}"
                                        class="img-fluid" alt=""></div>
                                <span
                                    class="post-date">{{ \Carbon\Carbon::parse($artikel->publish)->format('d M Y') }}</span>
        ...
        <section id="contact" class="contact">
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row gy-4">
                    ...
                    <div class="col-lg-6">
                        <iframe src="{!! $profils->url_map !!}" width="100%" height="350" style="border:0;"
