                    ...
                    <tr>
                        ...
                        <td><a href="">{{ $booking->coderandom }}-{{ $booking->jenis }}</a><br> --}}
                            ...
                            <td>
                                @if ($booking->status == 'pending')
                                    <div class="btn-group">
                                        <a href="booking/print/{{ $booking->id }}" target="_blank"
                                            class="btn btn-gray-800 text-white"><svg xmlns="http://www.w3.org/2000/svg"
                                        ...
                                        <button wire:click="getcheckin({{ $booking->id }})" title="Checkin"
                                            class="btn btn-success text-white"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="16" height="16" fill="currentColor"
                                                class="bi bi-door-open-fill" viewBox="0 0 16 16">
                                                <path
                                                    d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z" />
                                            </svg></button>
                                        <button wire:click="edit({{ $booking->id }})" title="Cancel"
                                            class="btn btn-danger text-white"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                @elseif ($booking->status == 'checkin')
                                    @can('menu-admin')
                                        ...
                                        <button wire:click="getuploads({{ $booking->id }})" type="button"
                                        ...
                                        <button wire:click="edit({{ $booking->id }})" title="Cancel"
                                            class="btn btn-sm btn-danger text-white"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="16" height="16" fill="currentColor" class="bi bi-x-circle"
                                                viewBox="0 0 16 16">
                                                <path
                                                    d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" />
                                ...
                                @elseif ($booking->status == 'success')
                                    @can('menu-admin')
                                        <a href="{{ url('storage/' . $booking->image . '') }}"
                                            class="btn btn-primary btn-sm"><svg xmlns="http://www.w3.org/2000/svg"
                                                width="16" height="16" fill="currentColor"
