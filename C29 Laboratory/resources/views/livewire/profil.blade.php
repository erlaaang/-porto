    ...
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-2">
                        <img src="{{ url('storage/' . $profils->foto_kepala . '') }}" class="img-fluid rounded-start"
                            alt="..." width="100%">
                    </div>
                    <div class="col-md-10">
                        <div class="card-body">
                ...
                <div class="row g-0">
                    <div class="col-md-12">
                        <div class="card-body">
                            ...
                            <iframe src="{!! $profils->url_map !!}" width="100%" height="450" style="border:0;"
            ...
            <div class="card mb-3">
                <div class="row g-0">
                    <div class="col-md-4">
                        <div class="card-body">
                            <b>Logo:</b>
                            <p class="card-text"> <img src="{{ url('storage/' . $profils->logo . '') }}" width="100%">
                            </p>
                            <b>Favicon:</b>
                            <p class="card-text"> <img src="{{ url('storage/' . $profils->favicon . '') }}" width="100%">
                            </p>
                        </div>
                    </div>
                </div>
